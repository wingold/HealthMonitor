            ...
            <ul class="nav metismenu" id="side-menu">
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="clear">
                                <span class="block m-t-xs">
                                    <strong class="font-bold userName">王宇</strong>
                                </span>
                ...
                <li>
                    <a href="list_classrooms.html">
                        ...
                        <span class="nav-label">教室管理</span>
                    </a>
                </li>
                <li>
                    <a href="../class/list">
                ...
                <li>
                    <a href="list_courses.html">
                        <i class="fa fa-book" aria-hidden="true"></i>
                        <span class="nav-label">课程管理</span>
                    </a>
                </li>
                <li>
                    <a href="list_teachers.html">
                        <i class="fa fa-user fa-lg" aria-hidden="true"></i>
                        <span class="nav-label">教师管理</span>
                    </a>
                </li>
                <li>
                    <a href="list_students.html">
                        <i class="fa fa-graduation-cap" aria-hidden="true"></i>
                        <span class="nav-label">学生管理</span>
                    </a>
                </li>
                <li>
                    <a href="list_bracelet.html">
                        <i class="fa fa-circle-o-notch" aria-hidden="true"></i>
                        <span class="nav-label">手环管理</span>
                    </a>
                </li>
                <li>
                    <a href="list_parameter.html">
